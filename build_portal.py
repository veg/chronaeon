  ...
  <main>
    ...
    <section class="rams-hero">
      <div class="rams-container">
        ...
        <h1 class="rams-title">
          Molecular clock calibration directly on sequence manifolds.
        </h1>
        <p class="rams-lede">
          ChronAeon estimates nucleotide substitution rates, ancestral divergence dates, and lineage-specific clock regimes directly from pairwise genetic distance manifolds—eliminating phylogenetic tree reconstruction and Markov chain Monte Carlo sampling.
        </p>
