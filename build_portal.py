  ...
  <header class="rams-header">
    <div class="rams-container rams-nav-flex">
      <a href="index.html" class="rams-brand">
        <span class="rams-brand-name">ChronAeon</span>
        <span class="rams-brand-sep">/</span>
        <span class="rams-brand-desc">Tree-Free Molecular Clock Dating</span>
      </a>
      <nav class="rams-nav">
  ...
  <main>
    ...
    <section class="rams-hero">
      <div class="rams-container">
        ...
        <!-- Command-Line Usage Box -->
        <div class="rams-cli-box">
          <div class="rams-cli-header">
            <span class="rams-cli-label">COMMAND-LINE USAGE</span>
        ...
        <div class="rams-walkthrough-card">
          ...
          <div class="rams-walkthrough-figure">
            ...
            <!-- Biological Explanation of AutoClock Communities -->
            <div class="rams-community-explainer">
              <div class="rams-community-grid">
                <div class="rams-comm-card">
                  <div class="rams-comm-header">
                    <span class="rams-comm-dot dot-blue"></span>
                    <strong>Central Mid-Atlantic Corridor</strong>
                ...
                <div class="rams-comm-card">
                  <div class="rams-comm-header">
                    <span class="rams-comm-dot dot-green"></span>
                    <strong>Northeast Geographic Expansion Wave</strong>
                ...
                <div class="rams-comm-card">
                  <div class="rams-comm-header">
                    <span class="rams-comm-dot dot-amber"></span>
                    <strong>Virginia Founder Epicenter &amp; South</strong>
        ...
        <div class="rams-specs-table">
          <div class="rams-spec-row">
            ...
            <div class="rams-spec-val">Continuous pairwise sequence manifold via exact Tamura-Nei 93 (TN93) or neural representations; soft profile root defines ancestral origin without tree traversal.</div>
          </div>
          <div class="rams-spec-row">
          ...
          <div class="rams-spec-row">
            ...
            <div class="rams-spec-val">Streaming multi-block alignment and continuous sequence anomaly scoring at 400+ sequences/second to quarantine chimeras and sequencing artifacts.</div>
          </div>
          <div class="rams-spec-row">
        ...
        <div class="rams-pillars-grid">
          ...
          <div class="rams-pillar">
            <div>
              ...
              <h3 class="rams-pillar-title">Continuous Manifold Dating</h3>
          ...
          <div class="rams-pillar">
            <div>
              ...
              <h3 class="rams-pillar-title">Spectral AutoClock</h3>
              <p class="rams-pillar-text">
          ...
          <div class="rams-pillar">
            <div>
              ...
              <h3 class="rams-pillar-title">High-Throughput Streaming Sieve</h3>
              <p class="rams-pillar-text">
    ...
    <section id="tutorials" class="rams-section">
      <div class="rams-container">
        <div class="rams-section-header">
          <div class="rams-section-num">02</div>
          <div>
            <h2 class="rams-section-title">Tutorials &amp; Practitioner Documentation</h2>
            <p class="rams-section-desc">
        ...
        <div class="rams-tutorial-list">
          <!-- Tutorial 1 -->
          <div class="rams-tutorial-item">
            <div class="rams-tutorial-meta">
              <span class="rams-tutorial-tag">TUTORIAL 01</span>
              <span class="rams-tutorial-time">20 min read</span>
            </div>
            <div class="rams-tutorial-content">
              <h3 class="rams-tutorial-heading">
                <a href="tutorials/dating.html">Practical Molecular Clock Calibration &amp; Emergence Dating &rarr;</a>
              </h3>
              <p class="rams-tutorial-summary">
              ...
              <div class="rams-tutorial-code">
                <code>chronaeon date --beast data/06_zika_cuba_grubaugh2019/beast.xml.gz --loocv</code>
              </div>
            </div>
            <div class="rams-tutorial-actions">
              <a href="tutorials/dating.html" class="rams-btn-link">Read Tutorial &rarr;</a>
              <a href="tutorials/CHRONAEON_DATING_TUTORIAL.md" download class="rams-btn-subtle">Markdown (.md)</a>
            </div>
          </div>
          ...
          <div class="rams-tutorial-item">
            <div class="rams-tutorial-meta">
              <span class="rams-tutorial-tag">TUTORIAL 02</span>
              <span class="rams-tutorial-time">25 min read</span>
            </div>
            <div class="rams-tutorial-content">
              <h3 class="rams-tutorial-heading">
                <a href="tutorials/beast.html">ChronAeon for BEAST Users: A Translation Guide &rarr;</a>
              </h3>
              <p class="rams-tutorial-summary">
              ...
              <div class="rams-tutorial-code">
                <code>chronaeon date --beast data/tutorial_dengue4/beast.xml.gz --loocv</code>
              </div>
            </div>
            <div class="rams-tutorial-actions">
              <a href="tutorials/beast.html" class="rams-btn-link">Read Tutorial &rarr;</a>
              <a href="tutorials/CHRONAEON_FOR_BEAST_USERS.md" download class="rams-btn-subtle">Markdown (.md)</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="surveillance" class="rams-section">
      <div class="rams-container">
        ...
        <div class="rams-surveillance-grid">
          <!-- NextStrain -->
          <div class="rams-surveillance-card">
            <div>
              <div class="rams-surveillance-head">
                <span class="rams-surveillance-tag">NEXTSTRAIN STREAMING FEED</span>
                <span class="rams-surveillance-stat">3,221 genomes &bull; 25.5s</span>
              </div>
              <h3 class="rams-surveillance-title">
                <a href="surveillance/nextstrain/index.html">NextStrain Influenza Feeds: Manifold Dating vs. TreeTime &rarr;</a>
              </h3>
            ...
            <div class="rams-surveillance-links">
              <a href="surveillance/nextstrain/index.html" class="rams-btn-link">View Dossier &rarr;</a>
              <a href="data/surveillance_nextstrain_reproducibility.tar.gz" download class="rams-btn-subtle">Package (.tar.gz)</a>
            </div>
          </div>
          ...
          <div class="rams-surveillance-card">
            <div>
              <div class="rams-surveillance-head">
                <span class="rams-surveillance-tag">BV-BRC PLANETARY DATABASE</span>
                <span class="rams-surveillance-stat">10,000 genomes &bull; 49.6s</span>
              </div>
              <h3 class="rams-surveillance-title">
                <a href="surveillance/bvbrc/index.html">BV-BRC Influenza A/H3N2: Streaming Sieve &amp; Multi-Clock Deconvolution &rarr;</a>
              </h3>
              <p class="rams-surveillance-desc">
    ...
    <!-- Empirical Validation Compendium -->
    <section id="benchmarks" class="rams-section">
      <div class="rams-container">
        <div class="rams-section-header">
          <div class="rams-section-num">04</div>
          <div>
            <h2 class="rams-section-title">Empirical Concordance Compendium (42 Cohorts)</h2>
            <p class="rams-section-desc">
              Tree-free manifold dating evaluated against published Bayesian MCMC (BEAST 1.x / 2.x) across 42 author-deposited empirical cohorts spanning {total_taxa:,} sequences (1882–2026). Ingests author-deposited BEAST XML configurations directly.
            </p>
          </div>
        </div>
        ...
        <div class="rams-summary-strip">
          <div class="rams-summary-item">
            <div class="rams-summary-label">Empirical Cohorts</div>
            <div class="rams-summary-value">42 Studies</div>
            <div class="rams-summary-sub">Author-deposited BEAST archives</div>
          </div>
          <div class="rams-summary-item">
            <div class="rams-summary-label">Sequence Scale</div>
            <div class="rams-summary-value">{total_taxa:,} Taxa</div>
            <div class="rams-summary-sub">Full genomes &amp; verified CDS</div>
          </div>
          <div class="rams-summary-item">
            <div class="rams-summary-label">Topology Requirement</div>
            <div class="rams-summary-value">Tree-Free</div>
            <div class="rams-summary-sub">Continuous distance manifolds</div>
          </div>
          <div class="rams-summary-item">
            <div class="rams-summary-label">Clock Formulations</div>
            <div class="rams-summary-value">6 Model Classes</div>
            <div class="rams-summary-sub">OLS, PGLS, Spline, Crash, Exp, Epoch</div>
          </div>
          <div class="rams-summary-item">
            <div class="rams-summary-label">Execution Latency</div>
            <div class="rams-summary-value">0.4s &ndash; 314s</div>
            <div class="rams-summary-sub">Sub-minute analytical dating</div>
          </div>
        </div>
        ...
        <div class="content-card" style="box-shadow: none; border: 1px solid #e5e5e5; padding: 0; overflow: hidden;">
...
{table_rows_str}
  ...
  <footer style="background: #ffffff; border-top: 1px solid #e5e5e5; padding: 2.5rem 0; margin-top: 2rem;">
    <div class="rams-container" style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap; gap: 1rem; font-size: 0.82rem; color: #777777;">
      ...
      <div>
        Institute for Genomics and Evolutionary Medicine (iGEM) &bull; Temple University &bull; Sergei L. Kosakovsky Pond
      </div>
    </div>
  </footer>
